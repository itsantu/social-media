  ...
  return (
    <div className="container  mx-auto px-10 py-10 rounded-3xl shadow-2xl w-screen md:max-w-[600px] mt-24">
      <div className="flex justify-between items-center mb-5">
        ...
        <p onClick={() => logout()} className="flex items-center gap-2 text-sm md:text-md cursor-pointer px-3 py-2 bg-slate-200 hover:bg-slate-400 rounded-md duration-200">Logout <IoLogOutOutline className="text-gray-950"/></p>
      </div>
