...
const PostForm = () => {
  ...
  return (
    <div className={`container mx-auto w-[85%] p-5 max-w-[600px] rounded-xl m-5 ${mode == 'dark' && "bg-gray-800"}`}>
      ...
      <form onSubmit={handleSubmit} encType='multipart/form-data'>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full p-2 border border-gray-300 rounded ${mode == "dark" && "text-gray-200"}`}
            required
            accept="image/*"
          />
        </div>
        <button
          type="submit"
          className={`${!fetching ? "bg-blue-500 text-white hover:bg-blue-700" : "bg-blue-800 text-gray-300"}  duration-150 p-3 w-full  rounded-md`}
          disabled={fetching}
        >
